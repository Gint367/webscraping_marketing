...
def run_pipeline(config: Dict[str, Any]) -> str:
    ...
    try:
        ...
        if final_output_path and Path(final_output_path).exists():  # Check if final_output is set and exists
            ...
            logger.error(f"Final output file from integration phase not found: {final_output_path}")
            raise FileNotFoundError(f"Final output file from integration phase not found: {final_output_path}")
