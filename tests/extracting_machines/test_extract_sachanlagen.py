...
from extracting_machines.extract_sachanlagen import (
    check_and_reprocess_error_files,
    convert_german_number,
    extract_category_from_input_path,
    process_files,
)
...
class TestProcessFilesSkipping(unittest.TestCase):
    ...
    async def test_main_function_passes_overwrite_parameter_correctly(self, mock_process_files,
        ...
        [os.path.join("root", "file1.html"), os.path.join("root", "file2.html")]
        mock_process_files.assert_called_once()
